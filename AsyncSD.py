    ...
    def catainfer(
        ...
        while True:
            ...
            #####################
                ...
                accept_indices, input_ids, new_token, hidden_states, sample_token = update_inference_inputs(
                    input_ids,
                    candidates,
                    best_candidate,
                    accept_length,
                ...
                # mixed_hidden_state: compress for lower transmission
                mixed_hidden_state = self.eagle3_fc[hidden_states]
